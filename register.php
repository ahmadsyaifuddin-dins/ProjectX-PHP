...
<body>
    <div class="container">
        <form method="POST" action="register.php">
            ...
            <div class="input-group" style="margin-bottom: 10px">
                ...
                <input type="email" id="email" name="email" class="form-control" placeholder="unknown@gmail.com"
                    required><br>
            </div>
            ...
            <div class="input-group" style="margin-bottom: 10px;">
                ...
                <button type="button" id="btnToggle2" class="toggle2">
                    <i id="eyeIcon" class="fa fa-eye"></i>
                </button>
            </div>
            ...
            <div class="input-group" style="margin-bottom: 10px;">
                ...
                <input type="text" id="ttl" class="form-control" placeholder="Denpasar, 09-Juni-2004" name="ttl"
                    required>
            </div>
            ...
            <button type="submit" class="btn btn-lg btn-primary btn-block" id="submit_form" name="submit"
                value=<?php echo date('l/d/M/Y-H:i:s:a'); ?>>R E G I S T E R</button><br>
    ...
    $(document).ready(function() {
        ...
        const toggleButton2 = document.getElementById('btnToggle2');
